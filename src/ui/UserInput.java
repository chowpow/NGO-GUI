...
public class UserInput {
    ...
    private void handleProjectInsert() {
        ...
        while (budget == INVALID_INPUT || (budget<= 1000000 && budget > 9999999)) {
            System.out.println("Please enter the director's budget (max 7 figures)");
            budget = readInt();
        }
    ...
    private void handleProjectInfo() {
        ...
        while (amount == INVALID_INPUT || (amount < 0 || amount > 999999)) {
            System.out.println("Find the budget and number of projects that have a budget greater than this amount: ");
            amount = readInt();
        }
